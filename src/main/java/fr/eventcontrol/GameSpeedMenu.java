...
public class GameSpeedMenu extends ChestMenu {
    ...
    private void refreshItems() {
        ...
        speedContainer.setItem(4, EventControl.namedItem(Items.SUGAR, "Vitesse des créatures"));
    ...
    public void clicked(int slotId, int button, ClickType clickType, Player player) {
        if (slotId < 0 || slotId >= speedContainer.getContainerSize()) {
